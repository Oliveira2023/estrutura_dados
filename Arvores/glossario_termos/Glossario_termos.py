...
class Glossario:
    ...
    def padronizar(self, termo):
        return termo.upper().strip()

    def inserir(self, termo, definicao):
        self.arvore.inserir(self.padronizar(termo), definicao)

    def remover(self, termo):
        self.arvore.remover(self.padronizar(termo))
...
while True:
    ...
    try:
        ...
        op = input(
            """
            Digite I para Inserir termo e definição
            Digite R para Remover termo
            Digite x para Sair
            """
        )
        print(op)
        ...
        if op == "I":
            termo = input("Entre com o termo: ")
            definicao = input("Entre com a definição: ")
            glossario.inserir(termo, definicao)
            continue

        if op == "R":
            termo = input("Entre com o termo: ")
            glossario.remover(termo)
            continue
    except Exception:
